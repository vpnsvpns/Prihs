# ⚡️ Проект Prihs — Энциклопедия по обходу блокировок в России

---

## 📖 Что у нас есть?

* **⚡️ VPN Подписки:** Актуальные конфигурации для продвинутых прокси-клиентов (Karing, Throne и др.).
...
* **🎯 Умные DNS:** Специальные профили для обхода блокировок нейросетей (Gemini, ChatGPT) и мобильных игр Supercell (Brawl Stars, Clash of Clans) без включения VPN.

---

## 📋 Вечно актуальные VPN-подписки

> **💡 Важно о списках:** Наши сабки универсальны. Они подходят как для **Черных списков** (когда заблокированы только отдельные сайты, например, Instagram, X, Discord), так и для **Белых списков** (когда мобильный интернет жестко ограничен и работают только одобренные ресурсы вроде Госуслуг и ВК).
